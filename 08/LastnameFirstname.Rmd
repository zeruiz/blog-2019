...
**Describe the difference between formats png, svg, and pdf. State your sources with (working!) links. Create an example of each of the image types with `ggplot2`** (use the same data and structure, so that you can compare file sizes as well).
