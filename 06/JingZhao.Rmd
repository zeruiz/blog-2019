...
### Issues:
My CV link worked Using R studio rmarkdown::render_site(). However, my CV link does not work any more when website is generated through github setting even though I have push all the files from my R studio to github. 