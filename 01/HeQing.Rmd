...
The biggest mishap was when one of the team member did not complete the work as promised and refused help. This is not something git can help to resolve. But, the git can make the cooperation of coding easier and much more efficient by avoiding sending codes to collaborators through cloud or email. 


2. **Give an example of one new git feature that you learned about from Jenny Bryan's book.**.
Github is new to me. The way github synic files are efficient since it can be done during the coding. Moreover, new files will not override the previous files, all changes are stored and easily pulled out for future self.
